  ...
  return (
    <section id="dlaczego" className="bg-muted/40 py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        {/* Header */}
        <Reveal className="text-center mb-28 max-w-3xl mx-auto">
        ...
        {/* USP grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto reveal-stagger">
          {whyUsContent.services.map((usp, index) => {
            ...
            return (
              <Reveal
                key={index}
                className="group transition-all duration-300 flex flex-col items-center text-center gap-6 hover:-translate-y-2"
              >
                {/* Icon Container */}
                <div
